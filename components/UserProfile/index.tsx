...
export function UserProfile({ user, isOwnProfile, dictionary }: UserProfileProps) {
  return (
        ...
        <div className="flex space-x-4 mb-4">
          ...
          {user.profile.websiteUrl && (
            ...
            >
              ...
              <span>{dictionary?.website}</span>
            </a>
          )}
        </div>
        <div>
          <h3 className="font-semibold mb-2">{dictionary?.skills}</h3>
