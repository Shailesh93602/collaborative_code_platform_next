...
import { ASTNode, CodeVisualizerProps } from './types';
...
export default function CodeVisualizer({ code, dictionary }: CodeVisualizerProps) {
  ...
  const renderTree = useCallback((data: ASTNode) => {
    const width = 600;
    const height = 400;
  ...
  return (
    <div className="border rounded-lg p-4 space-y-4">
      <h2 className="text-2xl font-semibold">{dictionary?.codeVisualization}</h2>
